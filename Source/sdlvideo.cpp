...
sdlvideo::sdlvideo (SDL_Window* window) : window (window)
{
  static const SDL_Color cl[16] = {
      {.r = 0x00, .g = 0x00, .b = 0x00}, {.r = 0x00, .g = 0x00, .b = 0xdd},
      {.r = 0x00, .g = 0xdd, .b = 0x00}, {.r = 0x00, .g = 0xdd, .b = 0xdd},
      {.r = 0xdd, .g = 0x00, .b = 0x00}, {.r = 0xdd, .g = 0x00, .b = 0xdd},
      {.r = 0xdd, .g = 0xdd, .b = 0x00}, {.r = 0xdd, .g = 0xdd, .b = 0xdd},
      {.r = 0x88, .g = 0x88, .b = 0x88}, {.r = 0x88, .g = 0x88, .b = 0xff},
      {.r = 0x88, .g = 0xff, .b = 0x88}, {.r = 0x88, .g = 0xff, .b = 0xff},
      {.r = 0xff, .g = 0x88, .b = 0x88}, {.r = 0xff, .g = 0x88, .b = 0xff},
      {.r = 0xff, .g = 0xff, .b = 0x88}, {.r = 0xff, .g = 0xff, .b = 0xff},
  };
