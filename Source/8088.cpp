...
#define INSTDBG_COMPARE(inst, name, REG1, REG2)                                                    \
  ...
  fprintf (stderr,                                                                                 \
           "INSTDBG: mismatch inst=%s reg=%s ax=%04x->%04x"                                        \
           " before=%04x result=%04x should be %04x\n",                                            \
           (inst), (name), instdbg_before.regs[0], instdbg_after.regs[0], (instdbg_before.REG1),   \
           (REG2), (instdbg_after.REG1))

#define INSTDBG_TEST_REG(inst) INSTDBG_TEST_OP (inst, reg2 (0), reg2 (1), reg2 (2))

#define INSTDBG_TEST_OP(inst, op1, op2, op3) INSTDBG_TEST_OPF (inst, op1, op2, op3, ~0)
...
#define E_TABLE2(a, b, c)                                                                          \
  switch (modrm & 070)                                                                             \
  {                                                                                                \
  case 000:                                                                                        \
    let##a##c (alu_rol##c (get##a##c(), (b)));                                                     \
    br;                                                                                            \
  case 010:                                                                                        \
    let##a##c (alu_ror##c (get##a##c(), (b)));                                                     \
    br;                                                                                            \
  case 020:                                                                                        \
    let##a##c (alu_rcl##c (get##a##c(), (b)));                                                     \
    br;                                                                                            \
  case 030:                                                                                        \
    let##a##c (alu_rcr##c (get##a##c(), (b)));                                                     \
    br;                                                                                            \
  case 040:                                                                                        \
    let##a##c (alu_shl##c (get##a##c(), (b)));                                                     \
    br;                                                                                            \
  case 050:                                                                                        \
    let##a##c (alu_shr##c (get##a##c(), (b)));                                                     \
    br;                                                                                            \
  case 060:                                                                                        \
    let##a##c (alu_shl##c (get##a##c(), (b)));                                                     \
    br;                                                                                            \
  case 070:                                                                                        \
    let##a##c (alu_sar##c (get##a##c(), (b)));                                                     \
    br;                                                                                            \
  }
#define E_AAM(a)                                                                                   \
  (a ? letreg1 (4, reg1 (0) / a), letreg1 (0, reg1 (0) % a), tmp2 = reg1 (0),                      \
   f_or (((tmp2 >= 128) ? 128 : 0) | (tmp2 ? 0 : 64) | ptable[tmp2]), f_mask (196) : E_INT (0))
#define E_AAD(a)                                                                                   \
  (letreg1 (0, reg1 (4) * (a) + reg1 (0)), letreg1 (4, 0), tmp2 = reg1 (0),                        \
   f_or (((tmp2 >= 128) ? 128 : 0) | (tmp2 ? 0 : 64) | ptable[tmp2]), f_mask (196))
#define E_SALC() letreg1 (0, f_get() & 1 ? 255 : 0)
#define E_XLAT()                                                                                   \
  (easeg = sregs[segover == 4 ? 3 : segover], eaofs = (reg2 (3) + reg1 (0)) & 65535, eamem = 1,    \
   letreg1 (0, getrm1()))
#define E_ESC() (E_WARN ("ESC"), getmodrm())
#define E_LOOPNE(a)                                                                                \
  (letreg2 (1, reg2 (1) + 65535), (reg2 (1) && !(f_get() & 64)) ? jmpn (a) : (void)0)
#define E_LOOPNEc(a)                                                                               \
  (letreg2 (1, reg2 (1) + 65535), (reg2 (1) && !(f_get() & 64)) ? jmpn (a), ca (19 - 12) : ca (5))
#define E_LOOPE(a)                                                                                 \
  (letreg2 (1, reg2 (1) + 65535), (reg2 (1) && (f_get() & 64)) ? jmpn (a) : (void)0)
#define E_LOOPEc(a)                                                                                \
  (letreg2 (1, reg2 (1) + 65535), (reg2 (1) && (f_get() & 64)) ? jmpn (a), ca (18 - 12) : ca (6))
...
#define E_TABLE3c(c)                                                                               \
  ...
  case 040:                                                                                        \
    E_MUL (c);                                                                                     \
    ca (eamem ? (c == 1 ? 76 /* ~83 */ : 124 /* ~139 */)                                           \
              : (c == 1 ? 70 /* ~77 */ : 118 /* ~133 */));                                         \
    br;                                                                                            \
  case 050:                                                                                        \
    E_IMUL (c);                                                                                    \
    ca (eamem ? (c == 1 ? 86 /* ~104 */ : 134 /* ~160 */)                                          \
              : (c == 1 ? 80 /* ~98 */ : 128 /* ~154 */));                                         \
    br;                                                                                            \
  case 060:                                                                                        \
    E_DIV (c);                                                                                     \
    ca (eamem ? (c == 1 ? 86 /* ~96 */ : 150 /* ~168 */)                                           \
              : (c == 1 ? 80 /* ~90 */ : 144 /* ~162 */));                                         \
    br;                                                                                            \
  case 070:                                                                                        \
    E_IDIV (c);                                                                                    \
    ca (eamem ? (c == 1 ? 107 /* ~118 */ : 171 /* ~190 */)                                         \
              : (c == 1 ? 101 /* ~112 */ : 165 /* ~184 */));                                       \
    br;                                                                                            \
  }
  ...
  for (; cycles_biu; cycles_biu--)
  {
    if (!biu_c)
    {
      ...
      else
      {
        ...
        {
          biu_pf = 1;
          pf_q[pf_wi] = memory_read ((sregs[1] & 65535) * 16 + (pf_wip & 65535), &i);
          biu_c += i;
        }
        else
          biu_c += 1;
...
static void biu_memw (t20 addr, t16 value)
{
  biu_ct();
  biu_f = 2;
  biu_address = addr & 1048575;
...
static void biu_out (t20 addr, t16 value)
{
  biu_ct();
  biu_f = 4;
  biu_address = addr & 65535;
...
static void f_or (t16 v)
{
  flagstmp |= v;
}

static void f_mask (t16 m)
{
  flags &= m ^ 0xffff;
  flags |= flagstmp & m;
}

static t16 f_get (void)
{
  return flags;
}

static void e_movsb (void) /* a4 */
{
  t16 tmp;
...
static void letreg1 (t16 n, t16 v)
{
  if (n >= 4)
  {
    regs[n - 4] &= 255;
...
static t16 reg2 (t16 n)
{
  return regs[n];
}

static void letreg2 (t16 n, t16 v)
{
  regs[n] = v & 65535;
}

static t16 reg12 (t16 n)
{
  t16 tmp;
...
static t16 getr1 (void)
{
  return reg1 ((modrm / 8) & 7);
}

static t16 getrc1 (void)
{
  return ca (1), getr1();
}

static void letr1 (t16 v)
{
  letreg1 ((modrm / 8) & 7, v);
}

static void letrc1 (t16 v)
{
  ca (1), letr1 (v);
}

static t16 getr2 (void)
{
  return reg2 ((modrm / 8) & 7);
}

static t16 getrc2 (void)
{
  return ca (1), getr2();
}

static void letr2 (t16 v)
{
  letreg2 ((modrm / 8) & 7, v);
}

static void letrc2 (t16 v)
{
  ca (1), letr2 (v);
}
...
static t16 getmem1 (t16 seg, t16 ofs)
{
  return biu_memr ((seg & 65535) * 16 + (ofs & 65535)) & 255;
}

static void letmem1 (t16 seg, t16 ofs, t16 v)
{
  biu_memw ((seg & 65535) * 16 + (ofs & 65535), v & 255);
}

static t16 getmem2 (t16 seg, t16 ofs)
{
  return getmem1 (seg, ofs) + getmem1 (seg, ofs + 1) * 256;
}

static void letmem2 (t16 seg, t16 ofs, t16 v)
{
  letmem1 (seg, ofs, v & 255);
  letmem1 (seg, ofs + 1, (v / 256) & 255);
}

static void jmpf (t16 seg, t16 ofs)
{
  sregs[1] = seg & 65535;
  ip = ofs & 65535;
  biu_clear();
...
static t16 do_add (t16 op1, t16 op2, t16 carry, t16 mask, t16 sign)
{
  t16 r;
  u32 tmp;
...
static t16 do_sub (t16 op1, t16 op2, t16 carry, t16 mask, t16 sign)
{
  t16 r;
  u32 tmp;
...
static t16 alu_add1 (t16 op1, t16 op2)
{
  t16 r;
...
static t16 alu_add2 (t16 op1, t16 op2)
{
  t16 r;
...
static t16 alu_sub1 (t16 op1, t16 op2)
{
  t16 r;
...
static t16 alu_sub2 (t16 op1, t16 op2)
{
  t16 r;
...
static t16 alu_or1 (t16 op1, t16 op2)
{
  t16 r;
...
static t16 alu_or2 (t16 op1, t16 op2)
{
  t16 r;
...
static t16 alu_adc1 (t16 op1, t16 op2)
{
  t16 r;
...
static t16 alu_adc2 (t16 op1, t16 op2)
{
  t16 r;
...
static t16 alu_sbb1 (t16 op1, t16 op2)
{
  t16 r;
...
static t16 alu_sbb2 (t16 op1, t16 op2)
{
  t16 r;
...
static t16 alu_and1 (t16 op1, t16 op2)
{
  t16 r;
...
static t16 alu_and2 (t16 op1, t16 op2)
{
  t16 r;
...
static t16 alu_xor1 (t16 op1, t16 op2)
{
  t16 r;
...
static t16 alu_xor2 (t16 op1, t16 op2)
{
  t16 r;
...
static void jmpna (t16 ofs)
{
  jmpf (sregs[1], ofs);
}

static void jmpn (t16 d)
{
  jmpna (ip + d);
}

static t16 alu_rol1 (t16 op1, t16 cl)
{
  t16 tmp, tmp2, c = cl;
...
static t16 alu_ror1 (t16 op1, t16 cl)
{
  t16 tmp, tmp2, c = cl;
...
static t16 alu_rcl1 (t16 op1, t16 cl)
{
  t16 tmp, tmp2, c = cl;
...
static t16 alu_rcr1 (t16 op1, t16 cl)
{
  t16 tmp, tmp2;
...
static t16 alu_shl1 (t16 op1, t16 cl)
{
  t16 tmp, c = cl;
...
static t16 alu_shr1 (t16 op1, t16 cl)
{
  t16 tmp, c = cl;
...
static t16 alu_sar1 (t16 op1, t16 cl)
{
  t16 tmp, c = cl;
...
static t16 alu_rol2 (t16 op1, t16 cl)
{
  t16 tmp, tmp2, c = cl;
...
static t16 alu_ror2 (t16 op1, t16 cl)
{
  t16 tmp, tmp2, c = cl;
...
static t16 alu_rcl2 (t16 op1, t16 cl)
{
  t16 tmp, tmp2, c = cl;
...
static t16 alu_rcr2 (t16 op1, t16 cl)
{
  t16 tmp, tmp2;
...
static t16 alu_shl2 (t16 op1, t16 cl)
{
  t16 tmp, c = cl;
...
static t16 alu_shr2 (t16 op1, t16 cl)
{
  t16 tmp, c = cl;
...
static t16 alu_sar2 (t16 op1, t16 cl)
{
  t16 tmp, c = cl;
...
static void out (t16 n, t16 v)
{
  biu_out (n & 65535, v & 255);
}

static t16 alu_neg1 (t16 op1)
{
  t16 r;
...
static t16 getacc1 (void)
{
  return reg1 (0);
}

static t16 getaccc1 (void)
{
  return ca (1), getacc1();
}

static t16 getacc2 (void)
{
  return reg2 (0);
}

static t16 getaccc2 (void)
{
  return ca (1), getacc2();
}
...
static void letacc1 (t16 v)
{
  letreg1 (0, v);
}

static void letaccc1 (t16 v)
{
  ca (1), letacc1 (v);
}

static void letacc2 (t16 v)
{
  letreg2 (0, v);
}

static void letaccc2 (t16 v)
{
  ca (1), letacc2 (v);
}

static t16 getimm1 (void)
{
  return get1();
}

static t16 getimmc1 (void)
{
  return ca (2), getimm1();
}

static t16 getimm2 (void)
{
  return get2();
}

static t16 getimmc2 (void)
{
  return ca (2), getimm2();
}

static t16 getimm12 (void)
{
  return get12();
}

static t16 getimmc12 (void)
{
  return ca (2), getimm12();
}

static void e_daa (void)
{
  t16 tmp, tmp2;
...
static void e_mul2 (void)
{
  ...
  if (dx)
    f_or (2049);
  f_mask (2049);
  INSTDBG_TEST_OPF ("mul %%cx", reg2 (0), instdbg_before.regs[1], reg2 (2), 2049);
#endif
}

static void e_imul1 (void)
{
#if 0
  unsigned int b, c, d;
  int f = 0;
...
static void e_imul2 (void)
{
  ...
  letreg2 (0, ax);
  letreg2 (2, dx);
  if (!(((ax & 32768) && dx == 65535) || ((ax & 32768) == 0 && dx == 0)))
    f_or (2049);
  f_mask (2049);
  INSTDBG_TEST_OPF ("imul %%cx", reg2 (0), instdbg_before.regs[1], reg2 (2), 2049);
#endif
}

static void e_int (t16 a)
{
  E_PUSH (flags);
  E_PUSH (cs);
  E_PUSH (ip);
...
static void e_idiv2 (void)
{
  ...
  INSTDBG_TEST_OPF ("idiv %%cx", reg2 (0), instdbg_before.regs[1], reg2 (2), 0);
}
...
int run8088 (void)
{
  ...
  for (;;)
  {
    ...
    case 0x6c:
    case 0x7c:
      E_JMPIFc ((tmp2 = f_get() & 2176, (tmp2 == 2048 || tmp2 == 128)));
      br;
    case 0x6d:
    case 0x7d:
      E_JMPIFc ((tmp2 = f_get() & 2176, (tmp2 == 0 || tmp2 == 2176)));
      br;
    case 0x6e:
    case 0x7e:
      E_JMPIFc ((tmp2 = f_get() & 2240,
                 (((tmp2 & 2176) == 2048 || (tmp2 & 2176) == 128) || (tmp2 & 64) == 64)));
      br;
    case 0x6f:
    case 0x7f:
      E_JMPIFc ((tmp2 = f_get() & 2240,
                 (((tmp2 & 2176) == 0 || (tmp2 & 2176) == 2176) && (tmp2 & 64) == 0)));
      br;
    case 0x80:
      getmodrm();
      E_TABLE1 (rmc, immc, 1);
