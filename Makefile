...
clean :
	rm jmain.o jmem.o sdlsound.o jvideo.o jkey.o jfdc.o stdfdc.o 8088.o 8259a.o jevent.o jjoy.o jbus.o jio1ff.o jrtc.o

5511emu : jmain.o jmem.o sdlsound.o jvideo.o jkey.o jfdc.o stdfdc.o 8088.o 8259a.o jevent.o jjoy.o jbus.o jio1ff.o jrtc.o
	$(CXX) -g -o 5511emu jmain.o jmem.o sdlsound.o jvideo.o jkey.o jfdc.o stdfdc.o 8088.o 8259a.o jevent.o jjoy.o jbus.o jio1ff.o jrtc.o `pkg-config sdl2 --libs`
...
jmain.o : jmain.cc jmem.hh sdlsound.hh jvideo.hh jtype.hh jkey.hh jfdc.hh stdfdc.hh jevent.hh jjoy.hh jbus.hh jio1ff.hh jrtc.hh
